...
vm.runInContext(source, context, {
  filename: 'Neon_Autopilot_HighSpeed_DroneHeat.region-scenery.js'
});
const scenery = context.window.NeonRegionScenery;
...
test('validates the complete ordered 30-family baseline configuration and rejects drift', () => {
  ...
  const actualZones = configuredContext.window.NeonConfig.zones;
