#!/usr/bin/env node
/* Pure-Node regression contract for the Neon directed cloverleaf graph, dynamics, itinerary, and launch ramp. */
'use strict';
...
function run() {
  check(track && typeof track.sampleEdge === 'function', 'NeonTrack did not load');
  const summary = {
    ok: true,
