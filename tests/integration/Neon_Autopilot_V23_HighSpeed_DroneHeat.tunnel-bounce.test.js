...
const visuals = globalThis.NeonV23CloverleafVisuals;
const poolFactory = globalThis.NeonV23CloverleafTilePool;
...
test('real tile-zero and runtime-tile frames receive only the authored diffuse floor with exact profile identity and lifecycle', () => {
  ...
  const pool = poolFactory.create({
    THREE, track, scene, modeling: globalThis.NeonV23Modeling,
