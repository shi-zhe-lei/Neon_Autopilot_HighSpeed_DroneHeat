...
const source = readFileSync(path.join(root, 'src/runtime/Neon_Autopilot_HighSpeed_DroneHeat.js'), 'utf8');
const gameplay = require(path.join(root, 'src/gameplay/Neon_Autopilot_HighSpeed_DroneHeat.gameplay-core.js'));
const { MESSAGES } = require(path.join(root, 'src/ui/Neon_Autopilot_HighSpeed_DroneHeat.i18n.js'));
