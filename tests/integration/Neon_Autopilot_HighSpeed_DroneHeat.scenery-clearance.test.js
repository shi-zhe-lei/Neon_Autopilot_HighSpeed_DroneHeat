...
const gameplayCore = globalThis.NeonGameplayCore;
const productionTrack = globalThis.NeonTrack;
const cloverleafVisuals = globalThis.NeonCloverleafVisuals;
const world = globalThis.NeonWorld;
const creatures = globalThis.NeonCreatures;
const candlelight = globalThis.NeonCandlelight;
const surfaceWeather = globalThis.NeonSurfaceWeather;
const ship = globalThis.NeonShip;
...
const TRANSPARENT_EFFECT_NAME_WHITELIST = Object.freeze(new Set([
  'Neon.SurfaceWeather.Puddles',
  'Neon.SurfaceWeather.CompressedTracks',
  'Neon.SurfaceWeather.DisplacedSnowRidges',
  'Neon.SurfaceWeather.PuddleRipples',
  'Neon.SurfaceWeather.WaterWakes',
  'Neon.SurfaceWeather.WaterSpray',
  'Neon.SurfaceWeather.SnowPowder'
]));
...
test('weather water/snow sheets stay millimetres above road and sealed snow banks keep a flat non-penetrating base', () => {
  ...
  assert.equal(bankGeometry.userData.neon.flatRoadBase, true);
