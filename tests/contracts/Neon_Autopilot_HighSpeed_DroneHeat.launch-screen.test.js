...
const runtime = readFileSync(
  join(PROJECT_ROOT, 'src/runtime/Neon_Autopilot_HighSpeed_DroneHeat.js'),
  'utf8'
);
const i18n = readFileSync(
  join(PROJECT_ROOT, 'src/ui/Neon_Autopilot_HighSpeed_DroneHeat.i18n.js'),
  'utf8'
);
...
test('launch information architecture keeps briefing, configuration, and actions in a stable order', () => {
  ...
  assert.match(launchMarkup, /Neon[\s\S]*?SKY[\s\S]*?DAWNFLIGHT/i);
});
