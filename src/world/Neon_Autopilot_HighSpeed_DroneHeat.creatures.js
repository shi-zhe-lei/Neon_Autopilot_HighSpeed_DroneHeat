...
window.NeonCreatures = (() => {
  ...
  function mergeClosedGeometries(THREE, components, metadata) {
    ...
    merged.userData.neonImmutableTopology = true;
    ...
    function buildRecord(definition, instanceIndex) {
      ...
      for (const qualityId of QUALITY_IDS) {
        ...
        mesh.userData = {
          ...
          lightCount: 0,
          artDirectionVersion: CREATURE_VISUAL_CONTRACT.version,
          spiritMaskCount: familyGeometry[qualityId].geometry.userData.neon.spiritMaskCount,
          maskEyeCount: familyGeometry[qualityId].geometry.userData.neon.maskEyeCount,
          modernMechanicalPartCount: 0,
