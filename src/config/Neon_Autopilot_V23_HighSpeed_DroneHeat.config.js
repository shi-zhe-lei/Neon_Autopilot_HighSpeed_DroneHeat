/* V23 world contract. Keep theme data isolated from gameplay state, collision, and autopilot decisions. */
window.NeonV23Config = (() => {
  'use strict';
  ...
  /**
   * Freezes nested zone contracts and retains the original flat lighting keys consumed by the V23 main
  ...
  if (Math.min(...authoredRealmFogDistancesM) !== sceneVisibilityContract.minimumAuthoredRealmFogFarM
    ...
    throw new RangeError('V23 realm fog distances must stay inside the shared scene-visibility envelope');
  }
