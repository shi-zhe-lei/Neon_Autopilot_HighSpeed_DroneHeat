/*
 * Neon bilingual UI authority / Neon 双语界面权威。
 *
...
(function bootstrapNeonI18n(browserWindow, factory) {
  ...
  const STORAGE_KEY = 'cc-neon-ui-language';
  const LANGUAGE_CHANGE_EVENT = 'neonneon:languagechange';
  ...
  const ZH_CN = Object.freeze({
    ...
    'autopilot.status.contractSurvival': 'Neon 极速保命',
    'autopilot.status.highSpeedSurvival': 'Neon 高速保命',
    'autopilot.status.extremeAvoidance': 'Neon 极限避障',
    'autopilot.status.dynamicAvoidance': 'Neon 动态避障',
    'autopilot.status.safetyFirst': 'Neon 安全优先',
    'autopilot.status.highSpeedSafety': 'Neon 高速安全',
    'autopilot.status.candlelightLocked': 'Neon 锁定烛光',
    'autopilot.status.collectAlongRoute': 'Neon 顺路收光',
    'autopilot.status.cloudCruise': 'Neon 云路巡航',
    'autopilot.status.preselectRoute': 'Neon 预选{route}',
    'autopilot.status.enterRoute': 'Neon 转入{route}',
    'autopilot.status.routeGuidance': 'Neon {route}领航',
    'autopilot.status.safeCruise': 'Neon 安全巡航',
    'autopilot.status.closeCorrection': 'Neon 近距修正',
    'autopilot.status.corridorPressure': '通道受压',
    'autopilot.status.closeAvoidance': '近距避障',
    'autopilot.status.instantAvoidance': 'Neon 即时避障',
    'autopilot.status.instantLine': '即时压线',
    'autopilot.status.instantCorridor': '即时通道',
    'autopilot.status.forcedAvoidance': 'Neon 强制避障',
    'autopilot.status.closeEscort': 'Neon 近距护航',
    ...
    'launch.brand': '霓虹自动领航 · Neon',
    'launch.title.top': 'Neon · 天际',
    ...
    'launch.runningStatus': 'Neon：每份烛光都会继续改变飞船颜色，并提升玩家与领航共享的横移操控、转速上限与升转速度；自动巡航会在真实阻力下稳定于{speed}。',
    ...
    'guide.footer.synced': 'Neon · 43 项规则已同步',
    ...
    'hint.main': 'Neon 天际晨航：从每小时 0 公里静止起步；松 W 立即切掉踏板额外推力，贴地1挡像汽车一样以真实怠速缓慢蠕行，S 可完全停住；推进核心与尾焰会按余转自然衰减。P 关闭时，M 在 W 手动与持续满油门之间切换，满油门没有 120 km/h 目标上限；P 开启时由领航统一调油、滑行和制动。T 独立切换 MT / AT；MT 用 Q / E 控制三挡，低速高挡会拖挡甚至完全失速；AT 禁用玩家 Q/E，并按 90 / 70 与 140 / 120 km/h 两组门槛自动覆盖三挡。F 只切换电影镜头并提供不扣生命的演出保护，不改变或屏蔽 P、M、T、方向、油门、刹车、跳跃与换挡。'
  });

  const EN = Object.freeze({
    'document.title': 'Neon Autopilot · Sky Dawnflight',
    ...
    'autopilot.status.contractSurvival': 'Neon target-speed survival',
    'autopilot.status.highSpeedSurvival': 'Neon high-speed survival',
    'autopilot.status.extremeAvoidance': 'Neon extreme avoidance',
    'autopilot.status.dynamicAvoidance': 'Neon dynamic avoidance',
    'autopilot.status.safetyFirst': 'Neon safety first',
    'autopilot.status.highSpeedSafety': 'Neon high-speed safety',
    'autopilot.status.candlelightLocked': 'Neon candlelight lock',
    'autopilot.status.collectAlongRoute': 'Neon en-route collection',
    'autopilot.status.cloudCruise': 'Neon cloud-route cruise',
    'autopilot.status.preselectRoute': 'Neon preselect {route}',
    'autopilot.status.enterRoute': 'Neon enter {route}',
    'autopilot.status.routeGuidance': 'Neon guide {route}',
    'autopilot.status.safeCruise': 'Neon safe cruise',
    'autopilot.status.closeCorrection': 'Neon close correction',
    'autopilot.status.corridorPressure': 'Corridor constrained',
    'autopilot.status.closeAvoidance': 'Close avoidance',
    'autopilot.status.instantAvoidance': 'Neon immediate avoidance',
    'autopilot.status.instantLine': 'Immediate edge line',
    'autopilot.status.instantCorridor': 'Immediate corridor',
    'autopilot.status.forcedAvoidance': 'Neon forced avoidance',
    'autopilot.status.closeEscort': 'Neon close escort',
    ...
    'launch.stage.name': 'Neon · Sky Dawnflight',
    ...
    'launch.brand': 'Neon Autopilot · Neon',
    'launch.title.top': 'Neon · Sky',
    ...
    'launch.runningStatus': 'Neon: every candlelight continues shifting craft color while improving lateral handling, RPM ceiling, and spool-up speed for both player and autopilot; automatic cruise settles at {speed} against real resistance.',
    ...
    'guide.eyebrow': 'Flight Manual · Neon',
    ...
    'guide.footer.synced': 'Neon · 43 rules synchronized',
    ...
    'update.eyebrow': 'Neon Live Update',
    ...
    'error.eyebrow': 'Neon Startup Recovery',
  ...
  const SOURCE_ALIASES = Object.freeze({
    '3D CC Runner · Neon Sky Dawnflight': 'document.title',
    ...
    'Neon 天际晨航：P 关闭时 M 为持续满油门且没有 120 km/h 目标上限；P 开启时领航统一调油、滑行和制动；F 只换电影镜头，不改变或屏蔽任何驾驶控制。': 'hint.main',
    ...
    'Neon · SKY DAWNFLIGHT': 'launch.stage.name',
    ...
    'NEON AUTOPILOT · Neon': 'launch.brand',
    'Neon · SKY': 'launch.title.top',
    ...
    'FLIGHT MANUAL · Neon': 'guide.eyebrow',
    ...
    'Neon LIVE UPDATE': 'update.eyebrow',
    'Neon STARTUP RECOVERY': 'error.eyebrow',
  ...
  function validateCatalogs() {
    ...
    if (referenceKeys.length !== englishKeys.length
      ...
      throw new TypeError(
        `Neon i18n catalogs differ; missing English: ${missingEnglish.join(', ') || 'none'}; `
          + `missing Chinese: ${missingChinese.join(', ') || 'none'}`
      );
    }
    for (const [key, value] of Object.entries(EN)) {
      if (HAN_PATTERN.test(value)) throw new TypeError(`English Neon i18n message contains Han text: ${key}`);
    }
  }
  ...
  function createI18n(scope = {}, options = {}) {
    ...
    const startup = options.startup ?? scope.NeonStartup ?? null;
    const diagnostics = {
    ...
    function translate(key, parameters = {}, translateOptions = {}) {
      ...
      if (translateOptions.strict === true) throw new RangeError(`Unknown Neon i18n key: ${messageKey}`);
    ...
    function translateSource(source, parameters = {}, translateOptions = {}) {
      ...
      if (translateOptions.strict === true) throw new RangeError(`Unknown Neon i18n source: ${candidate}`);
    ...
    * source values. WeakMap authority lets repeated Chinese/English switches remain reversible without HTML clones.
    ...
    function setLanguage(language, setOptions = {}) {
      ...
      if (!normalized) throw new RangeError(`Unsupported Neon UI language: ${language}`);
    ...
    function subscribe(listener) {
      if (typeof listener !== 'function') throw new TypeError('Neon i18n subscriber must be a function');
