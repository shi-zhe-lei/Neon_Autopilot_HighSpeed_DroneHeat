/*
 * Neon ethereal route-obstacle catalog and pooled visual factory / Neon 空灵道路障碍目录与池化视觉工厂。
...
window.NeonObstacles = (() => {
  ...
  function createFactory({
    ...
    modeling: providedModeling = window.NeonModeling,
    quality = undefined,
    qualityProfile = undefined,
    visualSeed = 'neon-obstacle-visuals',
    markOpaque = null,
    markEffect = null,
    ...unsupportedOptions
  } = {}) {
    ...
    if (!modeling?.createLoftGeometry
      ...
      throw new TypeError('Obstacle factory requires the Neon modeling geometry, material, and topology APIs.');
    }
    ...
    function acquire(options = {}) {
      ...
      const metadata = record.root.userData.neonObstacle;
    ...
    function release(candidate) {
      ...
      record.active = false;
      record.root.userData.neonObstacle.active = false;
  ...
  window.NeonObstacleFactory = api;
  return api;
})();
