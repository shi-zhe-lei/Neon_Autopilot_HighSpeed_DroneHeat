...
require(join(projectDirectory, 'src/rendering/Neon_Autopilot_HighSpeed_DroneHeat.modeling.js'));
require(join(projectDirectory, 'src/navigation/Neon_Autopilot_HighSpeed_DroneHeat.track.js'));
require(join(projectDirectory, 'src/navigation/Neon_Autopilot_HighSpeed_DroneHeat.cloverleaf.js'));
...
if (!track?.graph || typeof cloverleafVisuals?.createGeometryBatchAuditJob !== 'function') {
  throw new Error('Neon track or cloverleaf geometry benchmark contract did not load');
}
...
const report = Object.freeze({
  benchmark: 'neon-cloverleaf-geometry-batch',
