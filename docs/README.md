...
- `evidence/V23_PC_ULTRA_BEFORE_2560X1440.png` 与 `V23_PC_ULTRA_AFTER_2560X1440.png` 使用同一 `seed=2301&zone=2&weather=clear&quality=high` 查询和追尾相机；无遮挡飞行图另以 `V23_PC_ULTRA_AFTER_FLIGHT_2560X1440.png` 保存。
...
- `evidence/V23_PC_ULTRA_BEFORE_2560X1440.png` and `V23_PC_ULTRA_AFTER_2560X1440.png` use the same `seed=2301&zone=2&weather=clear&quality=high` query and chase camera; `V23_PC_ULTRA_AFTER_FLIGHT_2560X1440.png` provides the unobstructed flight view.
